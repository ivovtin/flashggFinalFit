...
SYSINPUTFILE="/afs/cern.ch/user/i/ivovtin/ttHHggbb/HHbbgg_ntuples_fromNadya/18_02_2020/workspaces_systematics/output_singleh.root,/afs/cern.ch/user/i/ivovtin/ttHHggbb/HHbbgg_ntuples_fromNadya/18_02_2020/workspaces_systematics/output_hh_node_SM_2016.root,/afs/cern.ch/user/i/ivovtin/ttHHggbb/HHbbgg_ntuples_fromNadya/18_02_2020/workspaces_systematics/output_hh_node_SM_2017.root,/afs/cern.ch/user/i/ivovtin/ttHHggbb/HHbbgg_ntuples_fromNadya/18_02_2020/workspaces_systematics/output_hh_node_SM_2018.root" # if no systematics, then whatever file is ok
...
# ./makeParametricModelDatacardFLASHgg.py -i $SIGNALFILE -s $SIGNALFILE --nodesFile $NODESFILE --signalProc $nodename -d $DATAFILE -p $PROCS,$nodename -c $CATS --photonCatScales ../Signal/dat/photonCatSyst.dat --photonCatSmears ../Signal/dat/photonCatSyst.dat --isMultiPdf  -o ${outname} --intLumi2016 $INTLUMI2016 --intLumi2017 $INTLUMI2017 --intLumi2018 $INTLUMI2018 --do_HHbbgg_systematics $DO_SYSTEMATIC --do2D --btagReshapeFalse $btagReshapeFalse
done
