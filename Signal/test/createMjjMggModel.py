...
def get_options():
    ...
    parser.add_option("--inp-dir",type='string',dest="inp_dir",default='/afs/cern.ch/user/i/ivovtin/ttHHggbb/CMSSW_10_2_13/src/flashggFinalFit/Signal/output/mgg/')
    parser.add_option("--inp-dir-mjj",type='string',dest="inp_dir_mjj",default='/afs/cern.ch/user/i/ivovtin/ttHHggbb/CMSSW_10_2_13/src/flashggFinalFit/Signal/output/mjj/')
    ...
    parser.add_option("--out-dir",type='string',dest="out_dir",default='/afs/cern.ch/user/i/ivovtin/ttHHggbb/CMSSW_10_2_13/src/flashggFinalFit/Signal/output/')
