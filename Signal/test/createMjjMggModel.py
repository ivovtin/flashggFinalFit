...
def get_options():
    ...
    parser.add_option("--inp-dir",type='string',dest="inp_dir",default='/afs/cern.ch/user/i/ivovtin/ttHHggbb/CMSSW_7_4_7/src/flashggFinalFit/Signal/output/outputMgg/')
    ...
    parser.add_option("--inp-dir-mjj",type='string',dest="inp_dir_mjj",default='/afs/cern.ch/user/i/ivovtin/ttHHggbb/CMSSW_7_4_7/src/flashggFinalFit/Signal/output/outputMjj/')
    ...
    parser.add_option("--inp-file",type='string',dest="inp_file",default='workspace_out_mgg.root')
    ...
    parser.add_option("--inp-file-mjj",type='string',dest="inp_file_mjj",default='workspace_out_mjj.root')
    ...
    parser.add_option("--out-dir",type='string',dest="out_dir",default='/afs/cern.ch/user/i/ivovtin/ttHHggbb/CMSSW_7_4_7/src/flashggFinalFit/Signal/output/')
